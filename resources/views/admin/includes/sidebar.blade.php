        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-home"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.language')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('create.language')}}" data-i18n="nav.dash.crypto">أضافة
                            لغه جديده </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('create.MainCat')}}" data-i18n="nav.dash.crypto">أضافة
                            قسم جديد </a>
                    </li>
                </ul>
            </li>
			 <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.SubMainCat')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('create.SubMainCat')}}" data-i18n="nav.dash.crypto">أضافة
                          قسم فرعى جديد </a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href="{{route('admin.vendors')}}"><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('create.Vendor')}}" data-i18n="nav.dash.crypto">أضافة
                            متجر جديد </a>
                    </li>
                </ul>
            </li>
