                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('create.MainCat')}}">إضافة قسم </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('save.MainCat')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> إضافه قسم جديد </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اختصار اللغه - {{__('messages.'.$lang->abbr)}}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <label for="switcheryColor4"
                                                                   class="card-title "> الحالة - {{__('messages.'.$lang->abbr)}} </label>
